...
let exampleMovie2 = Movie(id: UUID().uuidString, name: "Traveller", thumbnailURL: URL(string: "https://picsum.photos/200/301")!)
...
let exampleMovie5 = Movie(id: UUID().uuidString, name: "Mannial", thumbnailURL: URL(string: "https://picsum.photos/200/304")!)
